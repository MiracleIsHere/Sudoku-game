...
class SudokuBoardView(context: Context, attributeSet: AttributeSet) : View(context, attributeSet) {
    ...
    private val selectedStraightCellPaint = Paint().apply {
        style = Paint.Style.FILL_AND_STROKE
        color = Color.parseColor("#9a9a9a")
    }

    private val equalToCellPaint = Paint().apply {
        style = Paint.Style.FILL_AND_STROKE
        color = Color.parseColor("#4BC565")
    }
    ...
    private val conflictingValueCellPaint = Paint().apply {
        style = Paint.Style.FILL_AND_STROKE
        color = Color.parseColor("#f59842")
    }
    ...
    private val startingCellConflictTextPaint = Paint().apply {
        style = Paint.Style.FILL_AND_STROKE
        color = Color.RED
        typeface = Typeface.DEFAULT_BOLD
    }
    ...
    private fun updateMeasurements(width: Int) {
        ...
        startingCellConflictTextPaint.textSize = cellSizePixels / 1.5F
        conflictTextPaint.textSize = cellSizePixels / 1.5F
    }
    ...
    private fun fillCells(canvas: Canvas) {
        cells?.forEach {
            val r = it.row
            val c = it.col
            if (it.isStartingCell && r == selectedRow && c == selectedCol) {
                fillCell(canvas, r, c, selectedStraightCellPaint)

            } else if (r == selectedRow && c == selectedCol) {
                fillCell(canvas, r, c, selectedCellPaint)

            } else if (it.value == selectedValue &&
                (r == selectedRow || c == selectedCol) &&
                selectedValue != 0
            ) {
                fillCell(canvas, r, c, conflictingValueCellPaint)
            } else if (it.value == selectedValue &&
            ...
            } else if (it.value == selectedValue && selectedValue != 0) {
                fillCell(canvas, r, c, equalToCellPaint)
    ...
    private fun fillCell(canvas: Canvas, r: Int, c: Int, paint: Paint) {
        canvas.drawRect(
            c * cellSizePixels, r * cellSizePixels,
    ...
    private fun drawText(canvas: Canvas) {
        cells?.forEach { cell ->
            ...
            if (value == 0) {
                ...
                val paintToUse =
                    if (cell.isStartingCell && cell.conflicts.isEmpty()) startingCellTextPaint
                    else if (cell.isStartingCell && cell.conflicts.isNotEmpty()) startingCellConflictTextPaint
                    else if (cell.conflicts.isEmpty()) textPaint
                    else conflictTextPaint
    ...
    fun updateSelectedCellUI(row: Int, col: Int, value: Int) {
        selectedRow = row
        selectedCol = col
        selectedValue = value
        invalidate()
